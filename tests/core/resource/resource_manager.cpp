...
TEST_CASE("Simple Load", "[resource]")
{
    atmo::core::resource::ResourceManager::GetInstance().increaseTick(1);

    atmo::core::resource::Handle<SDL_Surface> h = {.assetId = "tests/core/resource/example_asset/atmo.png"};
...
TEST_CASE("Multiple Load", "[resource]")
{
    atmo::core::resource::ResourceManager::GetInstance().increaseTick(1);

    atmo::core::resource::Handle<SDL_Surface> h = {.assetId = "tests/core/resource/example_asset/atmo.png"};
    atmo::core::resource::Handle<SDL_Surface> h1 = {.assetId = "tests/core/resource/example_asset/atmo1.png"};
