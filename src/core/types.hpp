...
namespace atmo::core::types
{
    ...
    struct Color {
        ...
        static const Color TRANSPARENT_COL;
...
template <> struct atmo::meta::DefaultWidget<atmo::core::types::Color> {
    static constexpr const char *value = "color_picker";
};

template <> struct atmo::meta::DefaultWidget<atmo::core::types::Vector2> {
    static constexpr const char *value = "vector2";
};

template <> struct atmo::meta::DefaultWidget<atmo::core::types::Vector2i> {
    static constexpr const char *value = "vector2i";
};

template <> struct atmo::meta::DefaultWidget<atmo::core::types::Vector3> {
    static constexpr const char *value = "vector3";
};

template <> struct atmo::meta::DefaultWidget<atmo::core::types::Vector3i> {
    static constexpr const char *value = "vector3i";
};

template <> struct atmo::meta::DefaultWidget<atmo::core::types::Vector4> {
