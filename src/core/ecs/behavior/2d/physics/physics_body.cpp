...
//             spdlog::debug("Generating shape component for entity {} with shape {}", entity.name().c_str(),
//             entity.world().to_expr(&physics_body.shape).c_str()); createShapeForBody(entity, physics_body.body_id, physics_body);
//         });
