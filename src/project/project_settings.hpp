...
#define ATMO_SETTING_MAX_LENGTH 4096

struct App {
    ATMO_SETTING char project_name[ATMO_SETTING_MAX_LENGTH] = { 0 };
    ATMO_SETTING semver::version<VERSION_TYPES> engine_version;
    ATMO_SETTING semver::version<VERSION_TYPES> project_version;
    ATMO_SETTING char icon_path[ATMO_SETTING_MAX_LENGTH] = { 0 };
};
...
struct Boot {
    ...
    ATMO_SETTING char splash_icon_path[ATMO_SETTING_MAX_LENGTH] = { 0 };
};
...
struct ProjectSettings {
    ...
    ATMO_SETTING char default_scene[ATMO_SETTING_MAX_LENGTH] = { 0 };
};
